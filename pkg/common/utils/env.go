...
func ReplaceThriftVersion(targetDir string) {
	command := "go mod edit -replace github.com/apache/thrift=github.com/apache/thrift@v0.13.0"
	argv := strings.Split(command, consts.BlackSpace)

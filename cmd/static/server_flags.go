...
func serverFlags() []cli.Flag {
	...
	return []cli.Flag{
		...
		&cli.StringFlag{Name: config.OutDir, Value: ".", Aliases: []string{"o"}, Usage: "Specify the output path.", Destination: &globalArgs.ServerArgument.OutDir},
		&cli.StringFlag{Name: config.Template, Usage: "Specify the layout template.", Destination: &globalArgs.ServerArgument.Template, Value: config.Standard},

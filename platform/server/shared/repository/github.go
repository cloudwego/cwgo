...
func (a *GitHubApi) PushFilesToRepository(files map[string][]byte, owner, repoName, branch, commitMessage string) error {
	...
	newTree, _, err := a.client.Git.CreateTree(context.Background(), owner, repoName, *tempRef.Object.SHA, treeEntries)
	if err != nil {
		return err
	}
	...
	newCommit, _, err := a.client.Git.CreateCommit(
		...
		&github.Commit{
			...
			Tree:    newTree,
			Parents: []*github.Commit{{SHA: tempRef.Object.SHA}},
		},
	...
	pr, _, err := a.client.PullRequests.Create(context.TODO(), owner, repoName, &github.NewPullRequest{
		Title: github.String("generated by cwgo"),
		Head:  github.String(tempBranch),
		Base:  github.String(branch),
		Body:  github.String("generated by cwgo"),
	})
	if err != nil {
		return err
	}

	_, _, err = a.client.PullRequests.Merge(context.TODO(), owner, repoName, pr.GetNumber(), "generated by cwgo", &github.PullRequestOptions{
		CommitTitle:        "generated by cwgo",
		SHA:                "",
		MergeMethod:        "squash",
...
func (a *GitHubApi) DeleteAllFiles(owner, repoName, branch string) error {
	_, directoryContent, _, err := a.client.Repositories.GetContents(context.TODO(),
		owner, repoName, "",
	...
	for i, content := range directoryContent {
		deleteOpts[i] = &github.RepositoryContentFileOptions{
	...
	entries := make([]*github.TreeEntry, len(directoryContent))
	for i, content := range directoryContent {
	...
	tree, _, err := a.client.Git.GetTree(context.TODO(), owner, repoName, branch, true)
	if err != nil {
		return err
	}

	newTree, _, err := a.client.Git.CreateTree(context.TODO(), owner, repoName, tree.GetSHA(), []*github.TreeEntry{})
	if err != nil {
		return err
	}
	...
	newCommit, _, err := a.client.Git.CreateCommit(context.TODO(),
		owner, repoName,
		&github.Commit{
			Message: github.String("delete all file"),
			Tree:    newTree,

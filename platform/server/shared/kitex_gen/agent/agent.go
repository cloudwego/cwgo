...
type UpdateTasksReq struct {
	Tasks []*base.Task `thrift:"tasks,1" frugal:"1,default,list<base.Task>" json:"tasks"`
}
...
func (p *UpdateTasksReq) GetTasks() (v []*base.Task) {
	return p.Tasks
}
func (p *UpdateTasksReq) SetTasks(val []*base.Task) {
	p.Tasks = val
}
...
func (p *UpdateTasksReq) Field1DeepEqual(src []*base.Task) bool {

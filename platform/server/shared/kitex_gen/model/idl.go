...
type IDL struct {
	...
	IdlType      int32        `thrift:"idl_type,3" frugal:"3,default,i32" json:"idl_type"`
...
func (p *IDL) SetIdlType(val int32) {
	p.IdlType = val
}
...
func (p *IDL) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("idl_type", thrift.I32, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.IdlType); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *IDL) DeepEqual(ano *IDL) bool {
	...
	if !p.Field3DeepEqual(ano.IdlType) {
		return false
	}
...
func (p *IDL) Field3DeepEqual(src int32) bool {

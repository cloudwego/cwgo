...
type IDL struct {
	...
	CommitHash   string       `thrift:"commit_hash,4" frugal:"4,default,string" json:"commit_hash"`
	ImportIdls   []*ImportIDL `thrift:"import_idls,5" frugal:"5,default,list<ImportIDL>" json:"import_idls"`
...
func (p *IDL) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("commit_hash", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *IDL) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("import_idls", thrift.LIST, 5); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *IDL) DeepEqual(ano *IDL) bool {
	...
	if !p.Field4DeepEqual(ano.CommitHash) {
		return false
	}
	if !p.Field5DeepEqual(ano.ImportIdls) {
		return false
	}
...
func (p *IDL) Field5DeepEqual(src []*ImportIDL) bool {
...
func (p *IDL) Field8DeepEqual(src bool) bool {

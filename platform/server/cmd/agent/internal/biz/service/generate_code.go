...
func (s *GenerateCodeService) Run(req *agent.GenerateCodeReq) (resp *agent.GenerateCodeRes, err error) {
	...
	err = client.PushFilesToRepository(fileContentMap, owner, serviceRepositoryModel.RepositoryName, idlRepoModel.RepositoryBranch, "generated by cwgo")
	if err != nil {
		return &agent.GenerateCodeRes{

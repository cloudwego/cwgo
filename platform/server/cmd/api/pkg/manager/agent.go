...
func (m *Manager) newAgentClient(opts ...client.Option) (agentservice.Client, error) {
	...
	kxClient, err := agentservice.NewClient(
...
func (m *Manager) GetAgentClient() (kxClient agentservice.Client, err error) {
	return m.newAgentClient()
}

func (m *Manager) GetAgentClientByServiceID(serviceId string) (kxClient agentservice.Client, err error) {

...
func UpdateTemplate(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req templatemodel.UpdateTemplateReq
	...
	l := templatelogic.NewUpdateTemplateLogic(ctx, svc.Svc)

	resp := l.UpdateTemplate(&req)

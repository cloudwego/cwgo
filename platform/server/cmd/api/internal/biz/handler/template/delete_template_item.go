...
// DeleteTemplateItem .
// @router /template/item [DELETE]
func DeleteTemplateItem(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req templatemodel.DeleteTemplateItemReq
	...
	l := templatelogic.NewDeleteTemplateItemLogic(ctx, svc.Svc)

	resp := l.DeleteTemplateItem(&req)

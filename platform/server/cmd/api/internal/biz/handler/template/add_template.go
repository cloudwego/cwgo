...
func AddTemplate(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req templatemodel.AddTemplateReq
	...
	l := templatelogic.NewAddTemplateLogic(ctx, svc.Svc)

	resp := l.AddTemplate(&req)

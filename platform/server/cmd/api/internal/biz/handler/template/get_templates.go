...
// GetTemplates .
// @router /template [GET]
func GetTemplates(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req templatemodel.GetTemplatesReq
	...
	l := templatelogic.NewGetTemplatesLogic(ctx, svc.Svc)

	resp := l.GetTemplates(&req)

...
// Unregister .
// @router /registry/unregister [GET]
func Unregister(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req registrymodel.UnregisterReq
	...
	l := registrylogic.NewUnregisterLogic(ctx, svc.Svc)

	res := l.Unregister(&req)

...
// DeleteRepository .
// @router /repo [DELETE]
func DeleteRepository(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req repositorymodel.DeleteRepositoriesReq
	...
	l := repositorylogic.NewDeleteRepositoryLogic(ctx, svc.Svc)

	resp := l.DeleteRepository(&req)

...
// GetRepositories .
// @router /repo [GET]
func GetRepositories(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req repositorymodel.GetRepositoriesReq
	...
	l := repositorylogic.NewGetRepositoriesLogic(ctx, svc.Svc)

	resp := l.GetRepositories(&req)
	...
	response.OkWithData(rCtx, resp.Msg, resp.Data)
}

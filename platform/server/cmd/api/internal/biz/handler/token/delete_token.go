...
func DeleteToken(ctx context.Context, rCtx *app.RequestContext) {
	var err error
	var req tokenmodel.DeleteTokenReq
	...
	l := tokenlogic.NewDeleteTokenLogic(ctx, svc.Svc)

	resp := l.DeleteToken(&req)

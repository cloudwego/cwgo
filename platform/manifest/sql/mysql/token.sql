...
CREATE TABLE `token`  (
  ...
  `owner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'repository owner',
  ...
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'token status (0: expired, 1: valid)',
